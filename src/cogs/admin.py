...
from ..logger_factory import set_log_levels, get_logger
...
class AdminCog(commands.Cog):
    ...
    async def llmbot_restart(self, interaction: discord.Interaction):
        ...
        try:
            ...
            # Nothing else to do here; other components already hot-read on use.
    ...
    @app_commands.describe(level="Desired log level (INFO | DEBUG | FULL)")
